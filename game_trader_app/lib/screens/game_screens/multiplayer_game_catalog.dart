...
const List<MultiplayerGameDefinition> multiplayerGameCatalog = [
  ...
  MultiplayerGameDefinition(
    ...
    short: 'DICE',
    title: 'Dice Duel',
    subtitle: 'Pick the roll.',
    modeSummary: 'Pick 1-6. Matching players continue.',
    actionLabel: 'LOCK NUMBER',
    requiresAction: true,
    minStake: 1,
    imagePath: 'assets/images/neon_rise_bg.png',
    cardTag: 'ROOM',
    instructions: [
      'Each player picks one dice number before the timer ends.',
      'The room die rolls once. Players who match the roll stay in.',
      'If multiple players match, tie breaker rounds continue until one winner remains.',
    ],
  ),
  MultiplayerGameDefinition(
    key: 'TARGET_STRIKE',
